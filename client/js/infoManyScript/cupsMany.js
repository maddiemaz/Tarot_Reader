...
const getData = async () => {
    ...
    cupsA_elementIcon.innerText = responseCards.data[50].element_icon
    const cupsA_planetIcon = document.querySelector('#card1-imgUp')
    cupsA_planetIcon.innerText = responseCards.data[50].planet_icon
    const cupsA_astroIcon = document.querySelector('#card1-imgUp')
    cupsA_astroIcon.innerText = responseCards.data[50].astro_icon
    const cupsA_keyUp = document.querySelector('#card1-keyUp')
    cupsA_keyUp.innerText = responseCards.data[50].up_key
    const cupsA_keyRev = document.querySelector('#card1-keyRev')
    cupsA_keyRev.innerText = responseCards.data[50].rev_key
    ...
    cups2_elementIcon.innerText = responseCards.data[51].element_icon
    const cups2_planetIcon = document.querySelector('#card2-imgUp')
    cups2_planetIcon.innerText = responseCards.data[51].planet_icon
    const cups2_astroIcon = document.querySelector('#card2-imgUp')
    cups2_astroIcon.innerText = responseCards.data[51].astro_icon
    const cups2_keyUp = document.querySelector('#card2-keyUp')
    cups2_keyUp.innerText = responseCards.data[51].up_key
    const cups2_keyRev = document.querySelector('#card2-keyRev')
    cups2_keyRev.innerText = responseCards.data[51].rev_key
    ...
    cups3_elementIcon.innerText = responseCards.data[52].element_icon
    const cups3_planetIcon = document.querySelector('#card3-imgUp')
    cups3_planetIcon.innerText = responseCards.data[52].planet_icon
    const cups3_astroIcon = document.querySelector('#card3-imgUp')
    cups3_astroIcon.innerText = responseCards.data[52].astro_icon
    const cups3_keyUp = document.querySelector('#card3-keyUp')
    cups3_keyUp.innerText = responseCards.data[52].up_key
    const cups3_keyRev = document.querySelector('#card3-keyRev')
    cups3_keyRev.innerText = responseCards.data[52].rev_key
    ...
    cups4_elementIcon.innerText = responseCards.data[53].element_icon
    const cups4_planetIcon = document.querySelector('#card4-imgUp')
    cups4_planetIcon.innerText = responseCards.data[53].planet_icon
    const cups4_astroIcon = document.querySelector('#card4-imgUp')
    cups4_astroIcon.innerText = responseCards.data[53].astro_icon
    const cups4_keyUp = document.querySelector('#card4-keyUp')
    cups4_keyUp.innerText = responseCards.data[53].up_key
    const cups4_keyRev = document.querySelector('#card4-keyRev')
    cups4_keyRev.innerText = responseCards.data[53].rev_key
    ...
    cups5_elementIcon.innerText = responseCards.data[54].element_icon
    const cups5_planetIcon = document.querySelector('#card5-imgUp')
    cups5_planetIcon.innerText = responseCards.data[54].planet_icon
    const cups5_astroIcon = document.querySelector('#card5-imgUp')
    cups5_astroIcon.innerText = responseCards.data[54].astro_icon
    const cups5_keyUp = document.querySelector('#card5-keyUp')
    cups5_keyUp.innerText = responseCards.data[54].up_key
    const cups5_keyRev = document.querySelector('#card5-keyRev')
    cups5_keyRev.innerText = responseCards.data[54].rev_key
    ...
    cups6_elementIcon.innerText = responseCards.data[55].element_icon
    const cups6_planetIcon = document.querySelector('#card6-imgUp')
    cups6_planetIcon.innerText = responseCards.data[55].planet_icon
    const cups6_astroIcon = document.querySelector('#card6-imgUp')
    cups6_astroIcon.innerText = responseCards.data[55].astro_icon
    const cups6_keyUp = document.querySelector('#card6-keyUp')
    cups6_keyUp.innerText = responseCards.data[55].up_key
    const cups6_keyRev = document.querySelector('#card6-keyRev')
    cups6_keyRev.innerText = responseCards.data[55].rev_key
    ...
    cups7_elementIcon.innerText = responseCards.data[56].element_icon
    const cups7_planetIcon = document.querySelector('#card7-imgUp')
    cups7_planetIcon.innerText = responseCards.data[56].planet_icon
    const cups7_astroIcon = document.querySelector('#card7-imgUp')
    cups7_astroIcon.innerText = responseCards.data[56].astro_icon
    const cups7_keyUp = document.querySelector('#card7-keyUp')
    cups7_keyUp.innerText = responseCards.data[56].up_key
    const cups7_keyRev = document.querySelector('#card7-keyRev')
    cups7_keyRev.innerText = responseCards.data[56].rev_key
    ...
    cups8_elementIcon.innerText = responseCards.data[57].element_icon
    const cups8_planetIcon = document.querySelector('#card8-imgUp')
    cups8_planetIcon.innerText = responseCards.data[57].planet_icon
    const cups8_astroIcon = document.querySelector('#card8-imgUp')
    cups8_astroIcon.innerText = responseCards.data[57].astro_icon
    const cups8_keyUp = document.querySelector('#card8-keyUp')
    cups8_keyUp.innerText = responseCards.data[57].up_key
    const cups8_keyRev = document.querySelector('#card8-keyRev')
    cups8_keyRev.innerText = responseCards.data[57].rev_key
    ...
    cups9_elementIcon.innerText = responseCards.data[58].element_icon
    const cups9_planetIcon = document.querySelector('#card9-imgUp')
    cups9_planetIcon.innerText = responseCards.data[58].planet_icon
    const cups9_astroIcon = document.querySelector('#card9-imgUp')
    cups9_astroIcon.innerText = responseCards.data[58].astro_icon
    const cups9_keyUp = document.querySelector('#card9-keyUp')
    cups9_keyUp.innerText = responseCards.data[58].up_key
    const cups9_keyRev = document.querySelector('#card9-keyRev')
    cups9_keyRev.innerText = responseCards.data[58].rev_key
    ...
    cups10_elementIcon.innerText = responseCards.data[59].element_icon
    const cups10_planetIcon = document.querySelector('#card10-imgUp')
    cups10_planetIcon.innerText = responseCards.data[59].planet_icon
    const cups10_astroIcon = document.querySelector('#card10-imgUp')
    cups10_astroIcon.innerText = responseCards.data[59].astro_icon
    const cups10_keyUp = document.querySelector('#card10-keyUp')
    cups10_keyUp.innerText = responseCards.data[59].up_key
    const cups10_keyRev = document.querySelector('#card10-keyRev')
    cups10_keyRev.innerText = responseCards.data[59].rev_key
    ...
    cupsP_elementIcon.innerText = responseCards.data[60].element_icon
    const cupsP_planetIcon = document.querySelector('#card11-imgUp')
    cupsP_planetIcon.innerText = responseCards.data[60].planet_icon
    const cupsP_astroIcon = document.querySelector('#card11-imgUp')
    cupsP_astroIcon.innerText = responseCards.data[60].astro_icon
    const cupsP_keyUp = document.querySelector('#card11-keyUp')
    cupsP_keyUp.innerText = responseCards.data[60].up_key
    const cupsP_keyRev = document.querySelector('#card11-keyRev')
    cupsP_keyRev.innerText = responseCards.data[60].rev_key
    ...
    cupsKn_elementIcon.innerText = responseCards.data[61].element_icon
    const cupsKn_planetIcon = document.querySelector('#card12-imgUp')
    cupsKn_planetIcon.innerText = responseCards.data[61].planet_icon
    const cupsKn_astroIcon = document.querySelector('#card12-imgUp')
    cupsKn_astroIcon.innerText = responseCards.data[61].astro_icon
    const cupsKn_keyUp = document.querySelector('#card12-keyUp')
    cupsKn_keyUp.innerText = responseCards.data[61].up_key
    const cupsKn_keyRev = document.querySelector('#card12-keyRev')
    cupsKn_keyRev.innerText = responseCards.data[61].rev_key
    ...
    cupsQ_elementIcon.innerText = responseCards.data[62].element_icon
    const cupsQ_planetIcon = document.querySelector('#card13-imgUp')
    cupsQ_planetIcon.innerText = responseCards.data[62].planet_icon
    const cupsQ_astroIcon = document.querySelector('#card13-imgUp')
    cupsQ_astroIcon.innerText = responseCards.data[62].astro_icon
    const cupsQ_keyUp = document.querySelector('#card13-keyUp')
    cupsQ_keyUp.innerText = responseCards.data[62].up_key
    const cupsQ_keyRev = document.querySelector('#card13-keyRev')
    cupsQ_keyRev.innerText = responseCards.data[62].rev_key
    ...
    cupsKi_elementIcon.innerText = responseCards.data[63].element_icon
    const cupsKi_planetIcon = document.querySelector('#card14-imgUp')
    cupsKi_planetIcon.innerText = responseCards.data[63].planet_icon
    const cupsKi_astroIcon = document.querySelector('#card14-imgUp')
    cupsKi_astroIcon.innerText = responseCards.data[63].astro_icon
    const cupsKi_keyUp = document.querySelector('#card14-keyUp')
    cupsKi_keyUp.innerText = responseCards.data[63].up_key
    const cupsKi_keyRev = document.querySelector('#card14-keyRev')
    cupsKi_keyRev.innerText = responseCards.data[63].rev_key
