...
const getData = async () => {
    ...
    major0_elementIcon.src = responseCards.data[0].element_icon
    const major0_planetIcon = document.querySelector('#card0-imgUp')
    major0_planetIcon.src = responseCards.data[0].planet_icon
    const major0_astroIcon = document.querySelector('#card0-imgUp')
    major0_astroIcon.src = responseCards.data[0].astro_icon
    ...
    major1_elementIcon.src = responseCards.data[1].element_icon
    const major1_planetIcon = document.querySelector('#card1-imgUp')
    major1_planetIcon.src = responseCards.data[1].planet_icon
    const major1_astroIcon = document.querySelector('#card1-imgUp')
    major1_astroIcon.src = responseCards.data[1].astro_icon
    ...
    major2_elementIcon.src = responseCards.data[2].element_icon
    const major2_planetIcon = document.querySelector('#card2-imgUp')
    major2_planetIcon.src = responseCards.data[2].planet_icon
    const major2_astroIcon = document.querySelector('#card2-imgUp')
    major2_astroIcon.src = responseCards.data[2].astro_icon
    ...
    major3_elementIcon.src = responseCards.data[3].element_icon
    const major3_planetIcon = document.querySelector('#card3-imgUp')
    major3_planetIcon.src = responseCards.data[3].planet_icon
    const major3_astroIcon = document.querySelector('#card3-imgUp')
    major3_astroIcon.src = responseCards.data[3].astro_icon
    ...
    major4_elementIcon.src = responseCards.data[4].element_icon
    const major4_planetIcon = document.querySelector('#card4-imgUp')
    major4_planetIcon.src = responseCards.data[4].planet_icon
    const major4_astroIcon = document.querySelector('#card4-imgUp')
    major4_astroIcon.src = responseCards.data[4].astro_icon
    ...
    major5_elementIcon.src = responseCards.data[5].element_icon
    const major5_planetIcon = document.querySelector('#card5-imgUp')
    major5_planetIcon.src = responseCards.data[5].planet_icon
    const major5_astroIcon = document.querySelector('#card5-imgUp')
    major5_astroIcon.src = responseCards.data[5].astro_icon
    ...
    major6_elementIcon.src = responseCards.data[6].element_icon
    const major6_planetIcon = document.querySelector('#card6-imgUp')
    major6_planetIcon.src = responseCards.data[6].planet_icon
    const major6_astroIcon = document.querySelector('#card6-imgUp')
    major6_astroIcon.src = responseCards.data[6].astro_icon
    ...
    major7_elementIcon.src = responseCards.data[7].element_icon
    const major7_planetIcon = document.querySelector('#card7-imgUp')
    major7_planetIcon.src = responseCards.data[7].planet_icon
    const major7_astroIcon = document.querySelector('#card7-imgUp')
    major7_astroIcon.src = responseCards.data[7].astro_icon
    ...
    major8_elementIcon.src = responseCards.data[8].element_icon
    const major8_planetIcon = document.querySelector('#card8-imgUp')
    major8_planetIcon.src = responseCards.data[8].planet_icon
    const major8_astroIcon = document.querySelector('#card8-imgUp')
    major8_astroIcon.src = responseCards.data[8].astro_icon
    ...
    major9_elementIcon.src = responseCards.data[9].element_icon
    const major9_planetIcon = document.querySelector('#card9-imgUp')
    major9_planetIcon.src = responseCards.data[9].planet_icon
    const major9_astroIcon = document.querySelector('#card9-imgUp')
    major9_astroIcon.src = responseCards.data[9].astro_icon
    ...
    major10_elementIcon.src = responseCards.data[10].element_icon
    const major10_planetIcon = document.querySelector('#card10-imgUp')
    major10_planetIcon.src = responseCards.data[10].planet_icon
    const major10_astroIcon = document.querySelector('#card10-imgUp')
    major10_astroIcon.src = responseCards.data[10].astro_icon
    ...
    major11_elementIcon.src = responseCards.data[11].element_icon
    const major11_planetIcon = document.querySelector('#card11-imgUp')
    major11_planetIcon.src = responseCards.data[11].planet_icon
    const major11_astroIcon = document.querySelector('#card11-imgUp')
    major11_astroIcon.src = responseCards.data[11].astro_icon
    ...
    major12_elementIcon.src = responseCards.data[12].element_icon
    const major12_planetIcon = document.querySelector('#card12-imgUp')
    major12_planetIcon.src = responseCards.data[12].planet_icon
    const major12_astroIcon = document.querySelector('#card12-imgUp')
    major12_astroIcon.src = responseCards.data[12].astro_icon
    ...
    major13_elementIcon.src = responseCards.data[13].element_icon
    const major13_planetIcon = document.querySelector('#card13-imgUp')
    major13_planetIcon.src = responseCards.data[13].planet_icon
    const major13_astroIcon = document.querySelector('#card13-imgUp')
    major13_astroIcon.src = responseCards.data[13].astro_icon
    ...
    major14_elementIcon.src = responseCards.data[14].element_icon
    const major14_planetIcon = document.querySelector('#card14-imgUp')
    major14_planetIcon.src = responseCards.data[14].planet_icon
    const major14_astroIcon = document.querySelector('#card14-imgUp')
    major14_astroIcon.src = responseCards.data[14].astro_icon
    ...
    major15_elementIcon.src = responseCards.data[15].element_icon
    const major15_planetIcon = document.querySelector('#card15-imgUp')
    major15_planetIcon.src = responseCards.data[15].planet_icon
    const major15_astroIcon = document.querySelector('#card15-imgUp')
    major15_astroIcon.src = responseCards.data[15].astro_icon
    ...
    major16_elementIcon.src = responseCards.data[16].element_icon
    const major16_planetIcon = document.querySelector('#card16-imgUp')
    major16_planetIcon.src = responseCards.data[16].planet_icon
    const major16_astroIcon = document.querySelector('#card16-imgUp')
    major16_astroIcon.src = responseCards.data[16].astro_icon
    ...
    major17_elementIcon.src = responseCards.data[17].element_icon
    const major17_planetIcon = document.querySelector('#card17-imgUp')
    major17_planetIcon.src = responseCards.data[17].planet_icon
    const major17_astroIcon = document.querySelector('#card17-imgUp')
    major17_astroIcon.src = responseCards.data[17].astro_icon
    ...
    major18_elementIcon.src = responseCards.data[18].element_icon
    const major18_planetIcon = document.querySelector('#card18-imgUp')
    major18_planetIcon.src = responseCards.data[18].planet_icon
    const major18_astroIcon = document.querySelector('#card18-imgUp')
    major18_astroIcon.src = responseCards.data[18].astro_icon
    ...
    major19_elementIcon.src = responseCards.data[19].element_icon
    const major19_planetIcon = document.querySelector('#card19-imgUp')
    major19_planetIcon.src = responseCards.data[19].planet_icon
    const major19_astroIcon = document.querySelector('#card19-imgUp')
    major19_astroIcon.src = responseCards.data[19].astro_icon
    ...
    major20_elementIcon.src = responseCards.data[20].element_icon
    const major20_planetIcon = document.querySelector('#card20-imgUp')
    major20_planetIcon.src = responseCards.data[20].planet_icon
    const major20_astroIcon = document.querySelector('#card20-imgUp')
    major20_astroIcon.src = responseCards.data[20].astro_icon
    ...
    major21_elementIcon.src = responseCards.data[21].element_icon
    const major21_planetIcon = document.querySelector('#card21-imgUp')
    major21_planetIcon.src = responseCards.data[21].planet_icon
    const major21_astroIcon = document.querySelector('#card21-imgUp')
    major21_astroIcon.src = responseCards.data[21].astro_icon
    ...
    const major22_elementIcon = document.querySelector('#card22-imgUp')
    major22_elementIcon.src = responseCards.data[22].element_icon
    const major22_planetIcon = document.querySelector('#card22-imgUp')
    major22_planetIcon.src = responseCards.data[22].planet_icon
    const major22_astroIcon = document.querySelector('#card22-imgUp')
    major22_astroIcon.src = responseCards.data[22].astro_icon
