...
const getData = async () => {
    ...
    pentaclesA_planetIcon.innerText = responseCards.data[64].planet_icon
    const pentaclesA_astroIcon = document.querySelector('#card1-imgUp')
    pentaclesA_astroIcon.innerText = responseCards.data[64].astro_icon
    ...
    pentacles2_elementIcon.innerText = responseCards.data[65].element_icon
    const pentacles2_planetIcon = document.querySelector('#card2-imgUp')
    pentacles2_planetIcon.innerText = responseCards.data[65].planet_icon
    const pentacles2_astroIcon = document.querySelector('#card2-imgUp')
    pentacles2_astroIcon.innerText = responseCards.data[65].astro_icon
    ...
    pentacles3_elementIcon.innerText = responseCards.data[66].element_icon
    const pentacles3_planetIcon = document.querySelector('#card3-imgUp')
    pentacles3_planetIcon.innerText = responseCards.data[66].planet_icon
    const pentacles3_astroIcon = document.querySelector('#card3-imgUp')
    pentacles3_astroIcon.innerText = responseCards.data[66].astro_icon
    ...
    pentacles4_elementIcon.innerText = responseCards.data[67].element_icon
    const pentacles4_planetIcon = document.querySelector('#card4-imgUp')
    pentacles4_planetIcon.innerText = responseCards.data[67].planet_icon
    const pentacles4_astroIcon = document.querySelector('#card4-imgUp')
    pentacles4_astroIcon.innerText = responseCards.data[67].astro_icon
    ...
    pentacles5_elementIcon.innerText = responseCards.data[68].element_icon
    const pentacles5_planetIcon = document.querySelector('#card5-imgUp')
    pentacles5_planetIcon.innerText = responseCards.data[68].planet_icon
    const pentacles5_astroIcon = document.querySelector('#card5-imgUp')
    pentacles5_astroIcon.innerText = responseCards.data[68].astro_icon
    ...
    pentacles6_elementIcon.innerText = responseCards.data[69].element_icon
    const pentacles6_planetIcon = document.querySelector('#card6-imgUp')
    pentacles6_planetIcon.innerText = responseCards.data[69].planet_icon
    const pentacles6_astroIcon = document.querySelector('#card6-imgUp')
    pentacles6_astroIcon.innerText = responseCards.data[69].astro_icon
    ...
    pentacles7_elementIcon.innerText = responseCards.data[70].element_icon
    const pentacles7_planetIcon = document.querySelector('#card7-imgUp')
    pentacles7_planetIcon.innerText = responseCards.data[70].planet_icon
    const pentacles7_astroIcon = document.querySelector('#card7-imgUp')
    pentacles7_astroIcon.innerText = responseCards.data[70].astro_icon
    ...
    pentacles8_elementIcon.innerText = responseCards.data[71].element_icon
    const pentacles8_planetIcon = document.querySelector('#card8-imgUp')
    pentacles8_planetIcon.innerText = responseCards.data[71].planet_icon
    const pentacles8_astroIcon = document.querySelector('#card8-imgUp')
    pentacles8_astroIcon.innerText = responseCards.data[71].astro_icon
    ...
    pentacles9_elementIcon.innerText = responseCards.data[72].element_icon
    const pentacles9_planetIcon = document.querySelector('#card9-imgUp')
    pentacles9_planetIcon.innerText = responseCards.data[72].planet_icon
    const pentacles9_astroIcon = document.querySelector('#card9-imgUp')
    pentacles9_astroIcon.innerText = responseCards.data[72].astro_icon
    ...
    pentacles10_elementIcon.innerText = responseCards.data[73].element_icon
    const pentacles10_planetIcon = document.querySelector('#card10-imgUp')
    pentacles10_planetIcon.innerText = responseCards.data[73].planet_icon
    const pentacles10_astroIcon = document.querySelector('#card10-imgUp')
    pentacles10_astroIcon.innerText = responseCards.data[73].astro_icon
    ...
    pentaclesP_elementIcon.innerText = responseCards.data[74].element_icon
    const pentaclesP_planetIcon = document.querySelector('#card11-imgUp')
    pentaclesP_planetIcon.innerText = responseCards.data[74].planet_icon
    const pentaclesP_astroIcon = document.querySelector('#card11-imgUp')
    pentaclesP_astroIcon.innerText = responseCards.data[74].astro_icon
    ...
    pentaclesKn_elementIcon.innerText = responseCards.data[75].element_icon
    const pentaclesKn_planetIcon = document.querySelector('#card12-imgUp')
    pentaclesKn_planetIcon.innerText = responseCards.data[75].planet_icon
    const pentaclesKn_astroIcon = document.querySelector('#card12-imgUp')
    pentaclesKn_astroIcon.innerText = responseCards.data[75].astro_icon
    ...
    pentaclesQ_elementIcon.innerText = responseCards.data[76].element_icon
    const pentaclesQ_planetIcon = document.querySelector('#card13-imgUp')
    pentaclesQ_planetIcon.innerText = responseCards.data[76].planet_icon
    const pentaclesQ_astroIcon = document.querySelector('#card13-imgUp')
    pentaclesQ_astroIcon.innerText = responseCards.data[76].astro_icon
    ...
    pentaclesKi_elementIcon.innerText = responseCards.data[77].element_icon
    const pentaclesKi_planetIcon = document.querySelector('#card14-imgUp')
    pentaclesKi_planetIcon.innerText = responseCards.data[77].planet_icon
    const pentaclesKi_astroIcon = document.querySelector('#card14-imgUp')
    pentaclesKi_astroIcon.innerText = responseCards.data[77].astro_icon
