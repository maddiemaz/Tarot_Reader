...
const getData = async () => {
    ...
    swordsA_elementIcon.src = responseCards.data[36].element_icon
    const swordsA_planetIcon = document.querySelector('#card1-imgUp')
    swordsA_planetIcon.src = responseCards.data[36].planet_icon
    const swordsA_astroIcon = document.querySelector('#card1-imgUp')
    swordsA_astroIcon.src = responseCards.data[36].astro_icon
    ...
    swords2_elementIcon.src = responseCards.data[37].element_icon
    const swords2_planetIcon = document.querySelector('#card2-imgUp')
    swords2_planetIcon.src = responseCards.data[37].planet_icon
    const swords2_astroIcon = document.querySelector('#card2-imgUp')
    swords2_astroIcon.src = responseCards.data[37].astro_icon
    ...
    swords3_elementIcon.src = responseCards.data[38].element_icon
    const swords3_planetIcon = document.querySelector('#card3-imgUp')
    swords3_planetIcon.src = responseCards.data[38].planet_icon
    const swords3_astroIcon = document.querySelector('#card3-imgUp')
    swords3_astroIcon.src = responseCards.data[38].astro_icon
    ...
    swords4_elementIcon.src = responseCards.data[39].element_icon
    const swords4_planetIcon = document.querySelector('#card4-imgUp')
    swords4_planetIcon.src = responseCards.data[39].planet_icon
    const swords4_astroIcon = document.querySelector('#card4-imgUp')
    swords4_astroIcon.src = responseCards.data[39].astro_icon
    ...
    swords5_elementIcon.src = responseCards.data[41].element_icon
    const swords5_planetIcon = document.querySelector('#card5-imgUp')
    swords5_planetIcon.src = responseCards.data[41].planet_icon
    const swords5_astroIcon = document.querySelector('#card5-imgUp')
    swords5_astroIcon.src = responseCards.data[41].astro_icon
    ...
    swords6_elementIcon.src = responseCards.data[41].element_icon
    const swords6_planetIcon = document.querySelector('#card6-imgUp')
    swords6_planetIcon.src = responseCards.data[41].planet_icon
    const swords6_astroIcon = document.querySelector('#card6-imgUp')
    swords6_astroIcon.src = responseCards.data[41].astro_icon
    ...
    swords7_elementIcon.src = responseCards.data[42].element_icon
    const swords7_planetIcon = document.querySelector('#card7-imgUp')
    swords7_planetIcon.src = responseCards.data[42].planet_icon
    const swords7_astroIcon = document.querySelector('#card7-imgUp')
    swords7_astroIcon.src = responseCards.data[42].astro_icon
    ...
    swords8_elementIcon.src = responseCards.data[43].element_icon
    const swords8_planetIcon = document.querySelector('#card8-imgUp')
    swords8_planetIcon.src = responseCards.data[43].planet_icon
    const swords8_astroIcon = document.querySelector('#card8-imgUp')
    swords8_astroIcon.src = responseCards.data[43].astro_icon
    ...
    swords9_elementIcon.src = responseCards.data[44].element_icon
    const swords9_planetIcon = document.querySelector('#card9-imgUp')
    swords9_planetIcon.src = responseCards.data[44].planet_icon
    const swords9_astroIcon = document.querySelector('#card9-imgUp')
    swords9_astroIcon.src = responseCards.data[44].astro_icon
    ...
    swords10_elementIcon.src = responseCards.data[45].element_icon
    const swords10_planetIcon = document.querySelector('#card10-imgUp')
    swords10_planetIcon.src = responseCards.data[45].planet_icon
    const swords10_astroIcon = document.querySelector('#card10-imgUp')
    swords10_astroIcon.src = responseCards.data[45].astro_icon
    ...
    swordsP_elementIcon.src = responseCards.data[46].element_icon
    const swordsP_planetIcon = document.querySelector('#card11-imgUp')
    swordsP_planetIcon.src = responseCards.data[46].planet_icon
    const swordsP_astroIcon = document.querySelector('#card11-imgUp')
    swordsP_astroIcon.src = responseCards.data[46].astro_icon
    ...
    swordsKn_elementIcon.src = responseCards.data[47].element_icon
    const swordsKn_planetIcon = document.querySelector('#card12-imgUp')
    swordsKn_planetIcon.src = responseCards.data[47].planet_icon
    const swordsKn_astroIcon = document.querySelector('#card12-imgUp')
    swordsKn_astroIcon.src = responseCards.data[47].astro_icon
    ...
    swordsQ_elementIcon.src = responseCards.data[48].element_icon
    const swordsQ_planetIcon = document.querySelector('#card13-imgUp')
    swordsQ_planetIcon.src = responseCards.data[48].planet_icon
    const swordsQ_astroIcon = document.querySelector('#card13-imgUp')
    swordsQ_astroIcon.src = responseCards.data[48].astro_icon
    ...
    swordsKi_elementIcon.src = responseCards.data[49].element_icon
    const swordsKi_planetIcon = document.querySelector('#card14-imgUp')
    swordsKi_planetIcon.src = responseCards.data[49].planet_icon
    const swordsKi_astroIcon = document.querySelector('#card14-imgUp')
    swordsKi_astroIcon.src = responseCards.data[49].astro_icon
