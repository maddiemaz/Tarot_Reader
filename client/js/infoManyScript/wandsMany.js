...
const getData = async () => {
    ...
    wandsA_elementIcon.innerText = responseCards.data[22].element_icon
    const wandsA_planetIcon = document.querySelector('#card1-imgUp')
    wandsA_planetIcon.innerText = responseCards.data[22].planet_icon
    const wandsA_astroIcon = document.querySelector('#card1-imgUp')
    wandsA_astroIcon.innerText = responseCards.data[22].astro_icon
    ...
    wands2_elementIcon.innerText = responseCards.data[23].element_icon
    const wands2_planetIcon = document.querySelector('#card2-imgUp')
    wands2_planetIcon.innerText = responseCards.data[23].planet_icon
    const wands2_astroIcon = document.querySelector('#card2-imgUp')
    wands2_astroIcon.innerText = responseCards.data[23].astro_icon
    ...
    wands3_elementIcon.innerText = responseCards.data[24].element_icon
    const wands3_planetIcon = document.querySelector('#card3-imgUp')
    wands3_planetIcon.innerText = responseCards.data[24].planet_icon
    const wands3_astroIcon = document.querySelector('#card3-imgUp')
    wands3_astroIcon.innerText = responseCards.data[24].astro_icon
    ...
    wands4_elementIcon.innerText = responseCards.data[25].element_icon
    const wands4_planetIcon = document.querySelector('#card4-imgUp')
    wands4_planetIcon.innerText = responseCards.data[25].planet_icon
    const wands4_astroIcon = document.querySelector('#card4-imgUp')
    wands4_astroIcon.innerText = responseCards.data[25].astro_icon
    ...
    wands5_elementIcon.innerText = responseCards.data[26].element_icon
    const wands5_planetIcon = document.querySelector('#card5-imgUp')
    wands5_planetIcon.innerText = responseCards.data[26].planet_icon
    const wands5_astroIcon = document.querySelector('#card5-imgUp')
    wands5_astroIcon.innerText = responseCards.data[26].astro_icon
    ...
    wands6_elementIcon.innerText = responseCards.data[27].element_icon
    const wands6_planetIcon = document.querySelector('#card6-imgUp')
    wands6_planetIcon.innerText = responseCards.data[27].planet_icon
    const wands6_astroIcon = document.querySelector('#card6-imgUp')
    wands6_astroIcon.innerText = responseCards.data[27].astro_icon
    ...
    wands7_elementIcon.innerText = responseCards.data[28].element_icon
    const wands7_planetIcon = document.querySelector('#card7-imgUp')
    wands7_planetIcon.innerText = responseCards.data[28].planet_icon
    const wands7_astroIcon = document.querySelector('#card7-imgUp')
    wands7_astroIcon.innerText = responseCards.data[28].astro_icon
    ...
    wands8_elementIcon.innerText = responseCards.data[29].element_icon
    const wands8_planetIcon = document.querySelector('#card8-imgUp')
    wands8_planetIcon.innerText = responseCards.data[29].planet_icon
    const wands8_astroIcon = document.querySelector('#card8-imgUp')
    wands8_astroIcon.innerText = responseCards.data[29].astro_icon
    ...
    wands9_elementIcon.innerText = responseCards.data[30].element_icon
    const wands9_planetIcon = document.querySelector('#card9-imgUp')
    wands9_planetIcon.innerText = responseCards.data[30].planet_icon
    const wands9_astroIcon = document.querySelector('#card9-imgUp')
    wands9_astroIcon.innerText = responseCards.data[30].astro_icon
    ...
    wands10_elementIcon.innerText = responseCards.data[31].element_icon
    const wands10_planetIcon = document.querySelector('#card10-imgUp')
    wands10_planetIcon.innerText = responseCards.data[31].planet_icon
    const wands10_astroIcon = document.querySelector('#card10-imgUp')
    wands10_astroIcon.innerText = responseCards.data[31].astro_icon
    ...
    wandsP_elementIcon.innerText = responseCards.data[32].element_icon
    const wandsP_planetIcon = document.querySelector('#card11-imgUp')
    wandsP_planetIcon.innerText = responseCards.data[32].planet_icon
    const wandsP_astroIcon = document.querySelector('#card11-imgUp')
    wandsP_astroIcon.innerText = responseCards.data[32].astro_icon
    ...
    wandsKn_elementIcon.innerText = responseCards.data[33].element_icon
    const wandsKn_planetIcon = document.querySelector('#card12-imgUp')
    wandsKn_planetIcon.innerText = responseCards.data[33].planet_icon
    const wandsKn_astroIcon = document.querySelector('#card12-imgUp')
    wandsKn_astroIcon.innerText = responseCards.data[33].astro_icon
    ...
    wandsQ_elementIcon.innerText = responseCards.data[34].element_icon
    const wandsQ_planetIcon = document.querySelector('#card13-imgUp')
    wandsQ_planetIcon.innerText = responseCards.data[34].planet_icon
    const wandsQ_astroIcon = document.querySelector('#card13-imgUp')
    wandsQ_astroIcon.innerText = responseCards.data[34].astro_icon
    ...
    wandsKi_elementIcon.innerText = responseCards.data[35].element_icon
    const wandsKi_planetIcon = document.querySelector('#card14-imgUp')
    wandsKi_planetIcon.innerText = responseCards.data[35].planet_icon
    const wandsKi_astroIcon = document.querySelector('#card14-imgUp')
    wandsKi_astroIcon.innerText = responseCards.data[35].astro_icon
